...
try {
    ...
    //var kogurl = "https://openam-commkentwf-useast1-uat.id.forgerock.io/am/XUI/?realm=alpha&authIndexType=service&authIndexValue=kyid_loginPTA" + "&clocale=" + lang + "&locale=" + lang + "&CITDomainPart=isPartOfCITDomain";
    config = {
        "failureUrl": kogurl
    }
}
