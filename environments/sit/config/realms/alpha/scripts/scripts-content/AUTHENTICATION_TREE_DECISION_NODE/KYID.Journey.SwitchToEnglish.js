...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "SwitchToEnglish",
    script: "Script",
    scriptName: "KYID.Journey.SwitchToEnglish",
    timestamp: dateTime,
...
//          var link= decodeURIComponent(requestCookies.RequestURL)+"&clocale=en"+"&locale=en";
...
try {
    ...
    if(RequestURL === undefined || !RequestURL || RequestURL === null){
        ...
        var link= decodeURIComponent(vlink)+"&clocale=en"+"&locale=en";
        nodeLogger.error(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                +"::"+nodeConfig.scriptName+"::"+link);
        var redirect = callbacksBuilder.redirectCallback(link, null, "GET");
        action.goTo("redirect");
        ...
        var url = RequestURL;
        var link=RequestURL+"&clocale=en"+"&locale=en";
        nodeLogger.error(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                +"::"+nodeConfig.scriptName+"::"+link);
        var redirect = callbacksBuilder.redirectCallback(link, null, "GET");
        action.goTo("redirect");
