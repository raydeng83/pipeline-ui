    ...
    try{
         var auditLib = require("KYID.2B1.Library.AuditLogger")
              ...
              _queryFilter: 'mail eq "' + userEmail + '"'
                ...
                auditLib.auditLogger(code, sessionDetails, message, eventDetails, helpdeskUserId, userId, transactionId, userEmail , eventDetails.applicationName, sessionDetails.sessionRefId)
    }catch(error){
