...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "Expired OTP Error Message",
    script: "Script",
    scriptName: "KYID.2B1.Journey.errormessage.EmailSMSVoice.ExpiredOTP",
    timestamp: dateTime,
    errorMsg_EN: "esv.error.expiredotpemailsmsvoice.en",
    errorMsg_ES: "esv.error.expiredotpemailsmsvoice.es", 
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             nodeState.putShared("errorMessage_ExpiredOtp",errorMessage);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
