...
logger.error("differentemailretrylimit : "+differentemailretrylimit);
var emailretrylimit = nodeState.get("emailretrylimit");
logger.error("emailretrylimit : "+emailretrylimit);
var anotherfactor = nodeState.get("anotherFactor");
logger.error("anotherfactor : "+anotherfactor);
var changeEmailCount = nodeState.get("changeEmailCount");
logger.error("changeEmailCount : "+changeEmailCount);
...
if(nodeState.get("anotherFactor") != null){
 ...
 action.goTo("next");
    ...
    logger.error("Alternate_Email_Verification value is back")
    action.goTo("next");
}
    ...
    logger.error("Going to Next node")
    action.goTo("next");
}
