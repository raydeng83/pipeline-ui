...
try {
    ...
    logger.debug("Phone number is :::: "+ telephoneNumber)
...
function createUser(userData) {
    try {
         var createUserResponse = openidm.create("managed/alpha_user", null, userData);
          ...
          nodeLogger.info(transactionid+"::"+nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + "Account created successfully for the user"  +"::"+primaryEmail);    
              return true;
          }
        else{
            return false;
