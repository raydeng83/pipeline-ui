...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "Max Send Reached",
    script: "Script",
    scriptName: "KYID.2B1.Journey.errormessage.EmailSMSVoice.MaxTimeReached",
    timestamp: dateTime,
    errorMsg_EN: "esv.error.maxsendreachedsmsvoice.en",
    errorMsg_ES: "esv.error.maxsendreachedsmsvoice.es", 
