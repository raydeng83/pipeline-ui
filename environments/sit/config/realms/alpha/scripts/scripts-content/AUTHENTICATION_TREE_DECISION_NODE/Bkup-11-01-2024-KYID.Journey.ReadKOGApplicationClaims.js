...
if(nodeState.get("forgerockAppId") && nodeState.get("forgerockAppId") !=null) {
    applicationIdentifier  = nodeState.get("forgerockAppId");    
}  else {
                    ...
                    if(mfatypeValue != 0){
                        ...
                        try{
                            ...
                            for(var i=0;i<custom_MFAMethods.length;i++){
                                ...
                                logger.error("MFA method value is: "+method.MFAMethod+" | "+method.MFAStatus)
