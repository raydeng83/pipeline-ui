          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <p>We received a request to reset the password associated with your account. Please click the link below to reset your password.
</p>
                <p>
                  <a href="&{esv.portal.url}/reset-password?resumeURL={{object.resumeURI}}">Reset Password</a>
                </p>
                <p>This is a 
                  <b>one-time</b> use link and will expire in 
                  <b>10 minutes.</b>
                </p>
                <p>
