          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <p>Your KYID remote identity verification has been successfully completed. Please see below for the verification details:
</p>
                <p>Verification Type: {{object.verificationType}}
</p>
                <p>Verification Timestamp: {{object.timeStamp}}
</p>
                <p>
