          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <h2 style="text-align:left;margin-top:30px">Hola {{object.givenName}} {{object.lastName}},</h2>
                <p>Queríamos informarle que su contraseña se ha restablecido correctamente para la cuenta
</p>
                <p>Cuenta: {{object.mail}}</p>
                <p>Hora en que se restableció: {{object.date}}</p>
                <p>
