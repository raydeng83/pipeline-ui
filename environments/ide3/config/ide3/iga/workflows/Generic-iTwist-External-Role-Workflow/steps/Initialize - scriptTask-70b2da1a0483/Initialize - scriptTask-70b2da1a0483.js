...
logger.error("kyid-workflow starting workflow with request id: " + requestId);
...
try {
    ...
    logger.error("kyid-workflow userPrerequisite: " + userPrerequisite);
...
if (userPrerequisite && requestType) {
    try {
        ...
        logger.error("kyid-workflow init script failed with reason: " + e);
    }
} else {
