...
function updatePrerequisite(requestObj) {
    ...
    // var enrollmentRequestResult = openidm.patch("managed/alpha_kyid_enrollment_request/" + record.enrollmentRequestId, null, [{
    //     "operation": "replace",
    //     "field": "/status",
    //     "value": "REJECTED"
    // }]);
    ...
    var userPrerequisiteResult = openidm.patch("managed/alpha_kyid_enrollment_user_prerequisites/" + record._id, null, [{
            "operation": "replace",
            "field": "/status",
            "value": "REJECTED"
        },
