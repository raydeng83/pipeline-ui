...
if (enableAuditLog === "true") {
    ...
    function updateAttributes() {
         logger.error("alpha_group on update script method started")
        ...
        try {
            ...
            try {
                ...
                createdBy = ""
                logger.error("alpha_group on update script exception createdBy")
            }
            ...
            try {
                ...
                updatedBy = ""
                logger.error("alpha_group on update script exception updatedBy")
            }
            ...
            if (!((createdBy === "ETLUser" || createdBy === "KYIDConversion") && (updatedBy === "ETLUser" || updatedBy === "KYIDConversion"))) {
                ...
                try {
                    ...
                    isoDateTimeFormat = ""
                    logger.error("alpha_group on update script exception isoDateTimeFormat")
                }
                ...
                try {
                    ...
                    epochTimeFormat = ""
                    logger.error("alpha_group on update script exception epochTimeFormat")
                }
                ...
                try {
                    ...
                    usernameUpdatedBy = ""
                    logger.error("alpha_group on update script exception usernameUpdatedBy")
                }
            ...
            logger.error("alpha_group on update script exception while updating attributes")
        }
    }
