...
try {
    ...
    logger.error("alpha_application on create script exception while printing context and request value")
}
    ...
    function updateAttributes() {
        try {
            ...
            try {
                ...
                createdBy = ""
                logger.error("alpha_application on create script exception createdBy")
            }
            ...
            try {
                ...
                updatedBy = ""
                logger.error("alpha_application on create script exception updatedBy")
            }
            ...
            if (!((createdBy === "ETLUser" || createdBy === "KYIDConversion") && (updatedBy === "ETLUser" || updatedBy === "KYIDConversion"))) {
                ...
                try {
                    ...
                    isoDateTimeFormat = ""
                    logger.error("alpha_application on create script exception isoDateTimeFormat")
                }
                ...
                try {
                    ...
                    usernameCreatedBy = ""
                    logger.error("alpha_application on create script exception usernameUpdatedBy")
                }
            ...
            logger.error("alpha_application on create script exception while updating attributes")
        }
    }
