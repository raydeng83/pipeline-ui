...
if (enableAuditLog === "true") {
    ...
    function updateAttributes() {
        logger.debug("alpha_assignment on create script method started")
        ...
        try {
            ...
            try {
                ...
                createdBy = ""
                logger.error("alpha_assignment on create script exception createdBy")
            }
            ...
            try {
                ...
                updatedBy = ""
                logger.error("alpha_assignment on create script exception updatedBy")
            }
            ...
            if (!((createdBy === "ETLUser" || createdBy === "KYIDConversion") && (updatedBy === "ETLUser" || updatedBy === "KYIDConversion"))) {
                ...
                try {
                    ...
                    isoDateTimeFormat = ""
                    logger.error("alpha_assignment on create script exception isoDateTimeFormat")
                }
                ...
                try {
                    ...
                    epochTimeFormat = ""
                    logger.error("alpha_assignment on create script exception epochTimeFormat")
                }
                ...
                try {
                    ...
                    usernameCreatedBy = ""
                    logger.error("alpha_assignment on create script exception usernameUpdatedBy")
                }
