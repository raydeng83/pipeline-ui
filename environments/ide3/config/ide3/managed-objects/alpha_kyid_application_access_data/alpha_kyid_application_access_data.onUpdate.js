...
if (enableAuditLog === "true") {
    ...
    function updateAttributes() {
        logger.debug("alpha_kyid_application_access_data on update script method started")
        ...
        try {
            ...
            try {
                ...
                createdBy = ""
                logger.error("alpha_kyid_application_access_data on update script exception createdBy")
            }
            ...
            try {
                ...
                updatedBy = ""
                logger.error("alpha_kyid_application_access_data on update script exception updatedBy")
            }
            ...
            if (!((createdBy === "ETLUser" || createdBy === "KYIDConversion") && (updatedBy === "ETLUser" || updatedBy === "KYIDConversion"))) {
                ...
                try {
                    ...
                    isoDateTimeFormat = ""
                    logger.error("alpha_kyid_application_access_data on update script exception isoDateTimeFormat")
                }
                ...
                try {
                    ...
                    epochTimeFormat = ""
                    logger.error("alpha_kyid_application_access_data on update script exception epochTimeFormat")
                }
                ...
                try {
                    ...
                    usernameUpdatedBy = ""
                    logger.error("alpha_kyid_application_access_data on update script exception usernameUpdatedBy")
                }
            ...
            logger.error("alpha_kyid_application_access_data on update script exception while updating attributes")
        }
    }
