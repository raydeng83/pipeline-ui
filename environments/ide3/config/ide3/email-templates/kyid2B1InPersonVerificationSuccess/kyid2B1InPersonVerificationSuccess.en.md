...
<html>
  <head>
    <meta />
    <title>KYID In-Person Identity Verification Successful</title>
  </head>
          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <p>Your in-person identity verification for KYID has been successfully completed on {{object.timeStamp}}
</p>
