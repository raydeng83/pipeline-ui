          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <p>Su solicitud de acceso a {{{object.applicationNames}}} ha fallado. Puede ser un fallo temporal y puede volver a intentarlo después de un tiempo.
</p>
                <p>Si el problema persiste, comuníquese inmediatamente con nuestro equipo de soporte de KYID llamando al  {{object.phoneContact}} y seleccione la opción 2 para comunicarse directamente con ellos.
</p>
                <p>
                  <a href="&{esv.kyid.helpcenter.url}">Enlace al soporte técnico de KYID</a>
                </p>
                <p>KYID </p>
