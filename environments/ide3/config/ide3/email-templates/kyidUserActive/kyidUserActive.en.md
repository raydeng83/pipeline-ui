          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <h3>Kentucky Online Gateway - Account Activated </h3>
                <h2 style="text-align:left;margin-top:30px">Hi {{object.givenName}} {{object.sn}},</h2>
                <p>Your account has been activated
</p>
                <p>If you need any assistance, please contact our KYID Helpdesk Team immediately at 502-564-0106 and choose option 2 to connect directly with the Helpdesk Team.
</p>
