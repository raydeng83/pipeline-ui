          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <br />
                <span style="text-align:left;margin-top:30px"></span>
                <p style="margin-top:50px">
                           Se 
                  
                  <strong>rechazó</strong> una solicitud que usted envió 
                ...
                <p> Nombre de la aplicación: {{object.applicationName}}</p>
                <p> Nombre del rol: {{object.roleName}}</p>
                <p></p>
                <p></p>
                <br />
                <p>
Recibió este aviso porque usted es el usuario que solicitó el cambio o porque actuó conforme a esta solicitud. Si usted solicitó este cambio, corrija la solicitud y vuelva a enviarla.
</p>
