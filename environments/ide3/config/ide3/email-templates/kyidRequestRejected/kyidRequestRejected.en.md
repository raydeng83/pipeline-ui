            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <p style="margin-top:50px">
                           A request submitted by you was 
                ...
                <p> Application Name: {{object.applicationName}}</p>
                <p> Role Name: {{object.roleName}}</p>
                <p></p>
                <p></p>
                <br />
                <p>
You received this notice because you are the user who asked for the change, or you acted on this request.  If you asked for this change, correct the request and re-submit. 
</p>
                <p>If you have any question, please contact our KYID Helpdesk Team immediately at 502-564-0106 and choose option 2 to connect directly with the Helpdesk Team.
</p>
                <p>
                  <br />KYID
