                ...
                <table width="100%" border="1" cellpadding="10" cellspacing="0" style="border-collapse:collapse;margin:30px 0;border:1px solid #ddd">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>{{object.requesterFullName}}</td>
                      <td>{{object.timeStamp}}</td>
                    </tr>
                  </tbody>
                </table>
                <p>
                  Please click on the link below and follow the instructions to finish setting up your access. The invitation link would expire in 7 days and is for one-time use only.
                </p>
                <p>
