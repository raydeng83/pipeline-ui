          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <h3>KYID: Access Grant Failed </h3>
                <h2 style="text-align:left;margin-top:30px">Hi {{object.givenName}} {{object.sn}},</h2>
                <p>Your  access request for {{object.application}} failed. This may be a temporary failure and you can retry after sometime.
</p>
                <p>If the problem persists, please contact our KYID Helpdesk Team immediately at 502-564-0106 and choose option 2 to connect directly with the Helpdesk Team.
</p>
                <p>
