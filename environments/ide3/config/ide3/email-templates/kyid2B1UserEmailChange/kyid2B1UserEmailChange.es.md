          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <p>La dirección de correo electrónico principal asociada a su cuenta KYID se modificó recientemente:
                
              </p>
                <p>Dirección de correo electrónico anterior: {{object.oldMail}}</p>
                <p>Nueva dirección de correo electrónico:  {{object.newMail}}</p>
                <p>
