...
<html>
  <head>
    <meta />
    <title>KYID User Profile Update</title>
  </head>
          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <h2 style="text-align:left;margin-top:30px">Hi {{object.givenName}},</h2>
                <p>This is to inform you that your profile information was updated on 
                  ...
                  <b>{{object.timeStamp}}</b> during the 
                  
                  <b>changing your account authenticators.</b>
                </p>
                
                <p>Your account security is our priority. If you did not make these changes, please contact us immediately at {{object.phoneContact}} and choose option 2 to connect directly with the Helpdesk Team.
</p>
                <p>You can review your full profile by logging into your account here:  
                  ...
                  <a href="https://ide3.kyid.ky.gov/MyAccount" style="color:#0000FF;text-decoration:underline">KYID MyAccount Link</a>
                </p>
                <p>
                  <br />KYID
