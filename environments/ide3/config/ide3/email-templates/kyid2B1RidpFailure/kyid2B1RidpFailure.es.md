          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <p>Su reciente intento de verificación de identidad remota KYID no tuvo éxito. Consulte los detalles a continuación:
</p>
                <p>Tipo de verificación: {{object.verificationType}}
</p>
                <p>Horario: {{object.timeStamp}}
</p>
                <p>Motivo (si corresponde): {{object.failureReason}}
</p>
                <p>
