...
(function () {
    ...
    logger.error("access_v2B_aaron_test3: Auth check bypassed for testing")

    logger.error("===REQUEST in access_v2B_aaron_test3=== " + JSON.stringify(request));
    ...
    const ENDPOINT_NAME = "endpoint/access_v2B_aaron_test3"
