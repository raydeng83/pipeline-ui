...
(function () {
    ...
    if (request.method === 'create') {
        ...
        if (action === 1) {
            ...
            const CancelEnrollmentResponse = CancelEnrollment(payload.enrollmentRequestId)
    ...
    try {
        ...
        if (requestedUserDetails && requestedUserDetails.authenticators !== null) {
            ...
            for (i = 0; i < UserMFAResponse.resultCount; i++) {
                if (requiredMFACode === "5" && (UserMFAResponse.result[i].MFAMethod === "TOTP" || UserMFAResponse.result[i].MFAMethod === "PUSH" || UserMFAResponse.result[i].MFAMethod === "SYMANTEC")) {
                    foundMFA = true
                    break
                }
                else if (requiredMFACode === "4" && (UserMFAResponse.result[i].MFAMethod === "SMSVOICE" || UserMFAResponse.result[i].MFAMethod === "TOTP" || UserMFAResponse.result[i].MFAMethod === "PUSH" || UserMFAResponse.result[i].MFAMethod === "SYMANTEC")) {
                    foundMFA = true
                    break

                }
                else if (requiredMFACode === "3" && (UserMFAResponse.result[i].MFAMethod === "EMAIL" || UserMFAResponse.result[i].MFAMethod === "SECONDARY_EMAIL" || UserMFAResponse.result[i].MFAMethod === "SMSVOICE" || UserMFAResponse.result[i].MFAMethod === "TOTP" || UserMFAResponse.result[i].MFAMethod === "PUSH" || UserMFAResponse.result[i].MFAMethod === "SYMANTEC")) {
                    foundMFA = true
                    break
                }
            }
