            ...
            if(value.requestedUserId){
              ...
              if(userPrereqResponse == null){
                ...
                userPrereqResponse.forEach(val => {
                  if ((val && val.preRequisiteId && val.preRequisiteId.enrollmentActionSettings && val.preRequisiteId.enrollmentActionSettings.allowReuse === true) && (val.recordState === "ACTIVE" || val.recordState === "0")) {
