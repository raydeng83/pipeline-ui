  ...
  try{
    if(isEndpointExecutionAllowed === "true"){
      if (request.method === 'create') {
        ...
        throw logErrorDetails(500,'Unknown_Exception_Occurred1')
      ...
      //Return error response
       return logErrorDetails(500,'Unknown_Exception_Occurred2',error)
    }
  }());
...
function getUserProfile(apiRequestPayload) {
  ...
  try {
     ...
     return logErrorDetails(500,'Unknown_Exception_Occurred3',error)
  }
