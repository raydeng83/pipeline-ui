...
var nodeConfig = {
    ...
    node: "Node",
    nodeName: "GetUserIDfromExistingSession",
    script: "Script",
    scriptName: "KYID.Journey.FetchUserIDfromExistingSession",
    timestamp: dateTime,
...
if(existingSession.get("emailaddress")) {
    ...
    nodeLogger.error("AUDIT::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + " Email Not found in session");
    action.goTo(NodeOutcome.ERROR);
}

// Check if email is null, undefined, or an empty string
if (email === null || email === undefined) {
    nodeLogger.error(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "Email is null, undefined, or empty.");
    action.goTo(NodeOutcome.ERROR);
}

nodeLogger.error(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "Printing the email for the end user: " + email);
