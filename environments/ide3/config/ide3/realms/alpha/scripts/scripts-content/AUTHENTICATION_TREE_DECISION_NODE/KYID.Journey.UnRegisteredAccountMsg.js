...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "Don't create Profile Error Msg",
    script: "Script",
    scriptName: "KYID.Journey.UnRegisteredAccountMsg",
    timestamp: dateTime,
    errorMsg_EN: "esv.unregisteredusrmsg.en",
    errorMsg_ES: "esv.unregisteredusrmsg.es", 
...
var libFunc = "";
var clocale = "";
var unregisteredAccountErrorMessage = "";
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             unregisteredAccountErrorMessage = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("unregisteredAccountErrorMessage",unregisteredAccountErrorMessage);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+unregisteredAccountErrorMessage);
