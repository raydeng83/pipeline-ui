...
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.2B1.Journey.MFAAuthentication.DisplayMessageToUserToSendVoiceOTP",
    timestamp: dateTime,
...
function getTelephoneNumber() {
    ...
    if (userId) {
        ...
        if (userData && userData.telephoneNumber) {
            ...
            nodeLogger.debug("AUDIT::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "User data is null or telephone number is not available for user ID: " + userId);
        }
    } else {
        nodeLogger.debug("AUDIT::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "User ID is null or undefined.");
    }
    return null;
}
