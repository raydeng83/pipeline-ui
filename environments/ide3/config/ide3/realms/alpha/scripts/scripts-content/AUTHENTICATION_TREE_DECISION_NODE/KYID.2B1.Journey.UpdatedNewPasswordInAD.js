            ...
            if(result.records>0) {
                ...
                try {
                    ...
                    var ret1 = openidm.action('endpoint/ResetPassword', 'resetpassword', {  password: password, resource: systemUser });
                     //nodeLogger.debug(transactionid+"::"+nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script+"::"+nodeConfig.scriptName+"::"+nodeConfig.patchOperationFailed+"::"+"UpdatedNewPasswordInAD exception : Reset Password with Normal Password  Error Code : " + JSON.stringify(ret1)+"::"+UserSearchValue);
                     nodeLogger.debug(transactionid+"::"+nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script+"::"+nodeConfig.scriptName+"::"+"::"+"UpdatedNewPasswordInAD Response : Reset Password with Normal Password  Response Code : " + JSON.stringify(ret1)+"::"+UserSearchValue);
                      ...
                      logger.info("Inside If Block");
                        ...
                        //nodeLogger.debug(transactionid+"::"+nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script+"::"+nodeConfig.scriptName+"::"+nodeConfig.patchOperationFailed+"::"+"Password Reset Successfully"+"::"+UserSearchValue);
