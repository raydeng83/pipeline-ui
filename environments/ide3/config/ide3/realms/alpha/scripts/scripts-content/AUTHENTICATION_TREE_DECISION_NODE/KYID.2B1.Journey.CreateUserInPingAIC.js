...
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.2B1.Journey.CreateUserInPingAIC",
    timestamp: dateTime,
...
if (missingInputs.length > 0) {
    ...
    nodeLogger.debug(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + JSON.stringify(jsonObj));
    ...
    try {
        if (createUserSuccess) {
            //logger.debug("Creating user with following MFA details: " + usrEmailAddress + "|" + usrMobilePhoneNumber + "|" + usrSymantecVIPCredentialID);
