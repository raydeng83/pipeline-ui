...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "JIT Unknown Error",
    script: "Script",
    scriptName: "KYID.Journey.JITUnknownErrorMsg",
    timestamp: dateTime,
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             jitUnknownError = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("jitUnknownError",jitUnknownError);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+jitUnknownError);
