...
function decodeAndCleanEmail(emailId) {
    try {
        ...
        nodeLogger.debug(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "Error decoding email ID: " + error.message);
        return null;
    }
}
...
try {
    ...
    if (emailId) {
        ...
        logger.debug("email in line 86" +email)
        if (email) {
