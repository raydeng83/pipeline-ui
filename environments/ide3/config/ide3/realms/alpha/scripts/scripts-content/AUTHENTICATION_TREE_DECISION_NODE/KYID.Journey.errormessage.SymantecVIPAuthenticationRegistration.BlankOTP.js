...
// Node Config
 var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.Journey.errormessage.SymantecVIPAuthenticationRegistration.BlankOTP",
    timestamp: dateTime,
    errorMsg_EN: "esv.error.blankotp.symantec.en",
    errorMsg_ES: "esv.error.blankotp.symantec.es", 
