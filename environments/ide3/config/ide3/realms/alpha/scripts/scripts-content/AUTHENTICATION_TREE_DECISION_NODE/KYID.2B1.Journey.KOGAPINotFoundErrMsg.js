...
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.2B1.Journey.PTAFailedorInActiveInADFailMsg",
...
if (callbacks.isEmpty()) {
    //nodeLogger.error(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + transactionId +"::"+ nodeConfig.error+"::"+username);
            callbacksBuilder.textOutputCallback(0,"ERR-INP-LOG-001 - The email or password you entered is invalid. Please reenter the email and password and try again.")
