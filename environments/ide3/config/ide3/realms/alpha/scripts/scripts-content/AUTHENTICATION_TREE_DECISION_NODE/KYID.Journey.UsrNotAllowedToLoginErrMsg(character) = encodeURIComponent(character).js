...
// Node Config
 var nodeConfig = {
    ...
    timestamp: dateTime,
    errorMsg_EN: "esv.notallowedtologinerrormsg.en",
    errorMsg_ES: "esv.notallowedtologinerrormsg.es", 
...
var libFunc = "";
var clocale = "";
var notAllowedToLoginErrorMessage = "";
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             notAllowedToLoginErrorMessage = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("notAllowedToLoginErrorMessage",notAllowedToLoginErrorMessage);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+notAllowedToLoginErrorMessage);
