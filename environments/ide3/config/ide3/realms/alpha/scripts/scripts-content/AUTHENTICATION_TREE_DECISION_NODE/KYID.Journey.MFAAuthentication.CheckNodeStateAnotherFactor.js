...
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.Journey.MFAAuthentication.CheckNodeStateAnotherFactor",
    timestamp: dateTime,
...
if (isRegistrationAllowed === null || isRegistrationAllowed === undefined) {
    nodeLogger.error("AUDIT::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "isRegistrationAllowed is null or undefined.");
    ...
    if (nodeState.get("anotherFactor") === "anotherFactor") {
        if (isRegistrationAllowed === "true") {
            ...
            nodeLogger.error("AUDIT::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "Invalid value for isRegistrationAllowed: " + isRegistrationAllowed);
            outcome = NodeOutcome.FAILED;
        }
    } else {
