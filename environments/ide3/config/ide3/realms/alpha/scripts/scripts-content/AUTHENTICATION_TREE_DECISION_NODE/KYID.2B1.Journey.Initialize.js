...
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.2B1.Journey.Initialize",
    timestamp: dateTime,
...
try {
    ...
    var authnSessionMaxTime = SAMLTimeOut * 60 *1000;// 18,00,000
    var langCookie = "es"
    ...
    var url = systemEnv.getProperty("esv.kyid.tenant.fqdn"); //https://sso.dev.kyid.ky.gov
