...
//             else{  
//             if (!password || password == null) {
//                 nodeLogger.error(transactionid + "::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin +"::"+ "The OTP entered by the user is empty"+"::"+nodeConfig.errorId_BlankOTP );
//                 nodeState.putShared("errorMessage", null)
//                 nodeState.putShared("errorMessage_ExpiredOtp", null)
//                 nodeState.putShared("resendcodeMessage", null)
//                 nodeState.putShared("anotherFactor", null);
...
//                     nodeState.putShared("errorMessage_BlankOTP", null)
//                     nodeState.putShared("resendcodeMessage", null)
//                     nodeLogger.error(transactionid + "::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin +"::"+ "The OTP entered by the user is expired"+"::"+nodeConfig.errorId_ExpiredOTP +"::"+userEmail );
//                     action.goTo(NodeOutcome.EXPIRED);
//                 }
//                 else if (password && otpFromNodeState && otpFromNodeState === password) {
