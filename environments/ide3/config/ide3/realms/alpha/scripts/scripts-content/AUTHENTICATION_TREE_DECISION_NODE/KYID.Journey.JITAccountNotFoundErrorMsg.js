...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "JIT Not Found Error",
    script: "Script",
    scriptName: "KYID.Journey.JITAccountNotFoundErrorMsg",
    timestamp: dateTime,
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             jitNotFoundError = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("jitNotFoundError",jitNotFoundError);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+jitNotFoundError);
