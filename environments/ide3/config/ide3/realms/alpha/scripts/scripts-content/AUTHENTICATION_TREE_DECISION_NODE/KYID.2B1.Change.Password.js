...
function validatePassword(newpassword) {
    ...
    try {    
        if (nodeState.get("KOGID") && nodeState.get("KOGID") != null) {
            ...
            // logger.debug("IDM Query Response: " + JSON.stringify(response));
...
function main() {
    ...
    try {
        if (callbacks.isEmpty()) {
            ...
            //     logger.debug("Displaying invalid password error: " + error);
