...
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.2B1.Journey.IDProofing.FARS.DisplayFARS2.v2.1",
    timestamp: dateTime,
...
try {
   ...
   var userInfo = nodeState.get("userInfoJSON") || {};
    ...
    if(nodeState.get("errorMessageFARS")){
          displayFARS.submitedUserInfo.farsErrorMessage = nodeState.get("errorMessageFARS") || "";
    }
