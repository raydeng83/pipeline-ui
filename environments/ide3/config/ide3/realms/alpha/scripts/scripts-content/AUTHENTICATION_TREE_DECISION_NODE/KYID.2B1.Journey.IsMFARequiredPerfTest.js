...
try{
   if(isperftest.localeCompare("true")==0){
       nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script+"::"+nodeConfig.scriptName+"::PerfTestON::DisableEvaluateRisk");  
       nodeState.putShared("riskLevel","LOW")
       action.goTo(nodeOutcome.PerfON);
    } else {
       nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script+"::"+nodeConfig.scriptName+"::PerfTestOFF::EvaluateRiskEnabled");  
