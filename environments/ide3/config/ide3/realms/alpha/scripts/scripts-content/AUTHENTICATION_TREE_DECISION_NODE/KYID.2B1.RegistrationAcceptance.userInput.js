          ...
          if (selectedOutcome === 0) {
              ...
              if(checkName == true && checkLastName == true && checkEmail == true){
                ...
                action.goTo(NodeOutcome.NEXT); 
                  ...
                  nodeLogger.debug(transactionid + "::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin +"::"+ nodeConfig.errorLastName +"::"+ nodeConfig.errorId_firstNameValidation);
                  nodeState.putShared("errorMessage",null);
                  nodeState.putShared("errorInvalidName",null);
