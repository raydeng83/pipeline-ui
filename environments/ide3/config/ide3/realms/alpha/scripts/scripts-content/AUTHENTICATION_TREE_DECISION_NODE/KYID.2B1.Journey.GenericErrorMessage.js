...
var nodeConfig = {
    ...
    node: "Node",
    nodeName: "PTA : Something Went Wrong",
    script: "Script",
    scriptName: "KYID.2B1.Journey.GenericErrorMessage",
    timestamp: dateTime
}
...
if (callbacks.isEmpty()) {
    nodeLogger.debug(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + transactionId +"::"+ nodeConfig.error+"::"+username);
            callbacksBuilder.textOutputCallback(0,"An unexpected error has occurred while processing the request. Please try login again")
