...
logger.error("the script::::TBD.myappsscreen.rolelist")
var nodeConfig = {
        ...
        if (myAppSettings) {
            ...
            if (myAppSettings.associatedAppSystemName) {
                ...
                if(associatedAppName && associatedRoleList.length === 0){
                    ...
                    //  var associatedRoleName = myAppSettings.associatedRoleSystemName;
                    //    var associatedAppName = myAppSettings.associatedAppSystemName;
                    //     isRoleMatch = associatedAppName && associatedRoleName && userRoles.includes(associatedAppName+"-"+associatedRoleName);
