...
logger.debug("Printing the return value of getLocale function ::::::::: " + lang);
...
try {
    ...
    //var kogurl = "https://openam-commkentwf-useast1-dev.id.forgerock.io/am/XUI/?realm=alpha&authIndexType=service&authIndexValue=kyid_loginPTA" + "&clocale=" + lang + "&locale=" + lang + "&CITDomainPart=isPartOfCITDomain";
    config = {
        "failureUrl": kogurl
    }
}
