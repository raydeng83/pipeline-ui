...
(function () {
  logger.error("Inside KYID2B.OIDC.ClaimMapper.POC OIDC Claim Script");
    // SETUP
    ...
    utils.setClaimResolvers({
        ...
        */
        ...
        appClaims: function () {
          logger.error("Session Property appClaims " + session.getProperty("appClaims"));
 		    return session.getProperty('appClaims');
        }
    });
