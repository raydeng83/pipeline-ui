...
var nodeConfig = {
    ...
    scriptName: "KYID.2B1.Journey.SelfRegestration.Alternate.Phone.Back.Limit.Reached",
    script: "Script",
    timestamp: dateTime,
...
function handleUserResponses() {
    try {
        ...
        nodeState.putShared("backretrylimitforphone","true");
        nodeState.putShared("maxlimitforphoneback",null)
        nodeState.putShared("alternateemailbackcount",null)
