...
var nodeConfig = {
    ...
    scriptName: "KYID.2B1.Journey.SelfRegestration.Primary.Email.Back.Limit.Reached",
    script: "Script",
    timestamp: dateTime,
...
function handleUserResponses() {
    try {
        ...
        nodeState.putShared("firstbackretrylimit","true");
        nodeState.putShared("maxlimitforfirstback",null)
            action.goTo("true")
        } else {
