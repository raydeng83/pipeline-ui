...
function requestCallbacks() {
 ...
 var jsonobj = {
        ...
        if (nodeState.get("failedOrInactive")) {
            logger.debug("Failed or Inactive status inside password collector" + nodeState.get("failedOrInactive"));
            logger.debug("Failed or Inactive state");
            ...
            logger.debug("Disabled status inside password collector" + nodeState.get("accountDisabled"));
            logger.debug("Disabled state");
        ...
        if (selectedOutcome === 1) {
            ...
            if (password === null || !password) {
                ...
                if (nodeState.get("apireturnederror")) {
                    ...
                    //requestCallbacks();
                    logger.debug("User Disabled " + nodeState.get("accountDisabled"));
