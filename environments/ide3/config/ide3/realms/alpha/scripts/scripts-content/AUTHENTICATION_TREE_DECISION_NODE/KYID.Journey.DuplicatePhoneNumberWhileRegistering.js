...
function setErrorMessage() {
    ...
    var errorDuplicatePhoneNumber = "";

    if (clocale === "es") {
        errorDuplicatePhoneNumber = systemEnv.getProperty("esv.error.duplicatephonenumber.es");
    } else {
        errorDuplicatePhoneNumber = systemEnv.getProperty("esv.error.duplicatephonenumber.en");
    }
    
    nodeState.putShared("errorDuplicatePhoneNumber", errorDuplicatePhoneNumber);
    logger.error("Set error message: " + errorDuplicatePhoneNumber);
}
