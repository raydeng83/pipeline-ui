...
function logSharedState() {
    //logger.debug("Printing the shared state for MFA Context:::::: " + nodeState.get("isMFARequired"));
    //logger.debug(" :::: " + nodeState.get("requiredMFAMethodCode"));
   // logger.debug("::::"  + nodeState.get("IsRegistrationAllowed"));
}
...
// // Log the result
// logger.debug("Outcome determined: " + outcome);
