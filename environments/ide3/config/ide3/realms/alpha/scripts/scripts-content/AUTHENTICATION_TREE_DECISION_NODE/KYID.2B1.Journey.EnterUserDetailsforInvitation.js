...
var dateTime = new Date().toISOString();
  ...
  var nodeConfig = {
      ...
      script: "Script",
      scriptName: "KYID.2B1.Journey.EnterUserDetailsforInvitation",
      timestamp: dateTime,
...
//validates fisrtname and lastname
function isValidName(name) {
    ...
    logger.debug("Inside isValidName function")
   ...
   // var checkUserInput = lib.checkInput(name,restrictedEntries,null);
...
function handleUserResponses() {
         ...
         nodeLogger.debug(transactionid+ "::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" +  "Print Outcome Selected::" + selectedOutcome);
          ...
          //           nodeState.putShared("phoneExistingMessage",null);
          //           nodeState.putShared("invalidPhoneNumber",null);
          //           logger.debug("Inside Invalid First Name nodeoutcome")
          ...
          //           nodeState.putShared("phoneExistingMessage",null);
          //           nodeState.putShared("invalidPhoneNumber",null);
          //           logger.debug("Inside Invalid last Name nodeoutcome")
...
if (!isValidName(firstname) || !firstname || !isValidName(lastname) || !lastname) {
    clearSharedStates();
    action.goTo(NodeOutcome.INVALIDNAME);
