...
if (successMessage != null && successMessage) {
   ...
   var browser = successMessage.details.device.browser.name;
    ...
    // var location = {
    //     state: (typeof state !== "undefined" && state) ? state : "",
    //     usrLocCity: (typeof usrLocCity !== "undefined" && usrLocCity) ? usrLocCity : "",
    //     usrLocCountry: (typeof usrLocCountry !== "undefined" && usrLocCountry) ? usrLocCountry : ""
    //   };
    // nodeState.putShared("userLocation", JSON.stringify(location))
...
//nodeState.putShared("riskLevel","LOW") //hardcoded only in IDE3 for RIDP testing
}
