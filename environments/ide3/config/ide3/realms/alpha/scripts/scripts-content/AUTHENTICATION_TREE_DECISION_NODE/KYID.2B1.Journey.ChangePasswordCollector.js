...
function main() {
    ...
    try {
        if (callbacks.isEmpty()) {
           ...
           //  logger.debug("errorMsg KYID.2B1.Journey.ValidatePasswordPolicy_SP" + JSON.stringify(errorMsg));
                var changePwdErrMsg = nodeState.get("changePasswordValidationError");
            //logger.debug("changePwdErrMsg KYID.2B1.Journey.ValidatePasswordPolicy_SP" + JSON.stringify(errorMsg));
            //logger.debug("changePwdErrMsg KYID.2B1.Journey.ValidatePasswordPolicy_CH" + JSON.stringify(changePwdErrMsg));
          ...
          if(changePwdErrMsg !=null && changePwdErrMsg.code && changePwdErrMsg.message){
            ...
            // logger.debug("Callbacks received. Extracting password inputs.");
            ...
            if (isPassValid.outcome === false) {
               ...
               /// logger.debug("PasswordCheckADRes is false "+PasswordCheckADRes)
                ...
                // if (newPassword.localeCompare(reenteredPassword) == 0) {
                    ...
                    // }
                    // else{
                    // nodeLogger.error(transactionid+"::"+nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "New password and re-entered password match."+ "::"+ mail);
                    // if (validatePassword(newPassword)) {
                    //     nodeState.putShared("password", newPassword);
                    //      nodeLogger.error(transactionid+"::"+nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "::"+ nodeConfig.validatePwdSuccess+ "::"+ mail);                        
                    //     nodeState.putShared("changePasswordValidationError",null);
                    //     action.goTo(nodeOutcome.SUCCESS);
                    // } else {
                    //      nodeLogger.error(transactionid+"::"+nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "::"+nodeConfig.validatePwdFail+ "::"+ mail);
                    //     action.goTo(nodeOutcome.INVALID);
                    // }
                    // }
                // } else {
                //      nodeLogger.error(transactionid+"::"+nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin +"::"+nodeConfig.mismatchPassword+ "::"+ mail);
