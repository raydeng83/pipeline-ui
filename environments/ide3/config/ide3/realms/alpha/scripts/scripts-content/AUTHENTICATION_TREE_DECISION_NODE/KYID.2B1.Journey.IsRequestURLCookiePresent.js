/**
* Script: KYID.2B1.Journey.IsRequestURLCookiePresent
...
// Node Config
 var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.2B1.Journey.IsRequestURLCookiePresent",
    timestamp: dateTime,
...
function main(){
    ...
    try {
        logger.debug("reqUrlBackToLoginCookie value is: "+readCookieValueFromSession("RequestURL"))
