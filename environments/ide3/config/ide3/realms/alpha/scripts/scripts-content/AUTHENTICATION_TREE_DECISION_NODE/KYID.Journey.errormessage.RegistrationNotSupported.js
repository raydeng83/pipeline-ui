...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "Error Registration not Supported",
    script: "Script",
    scriptName: "KYID.Journey.errormessage.RegistrationNotSupportedP",
    timestamp: dateTime,
    errorMsg_EN: "esv.error.registration.notsupported.en",
    errorMsg_ES: "esv.error.registration.notsupported.es", 
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             errorRegistrationNotSupportedMessage = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("errorRegistrationNotSupportedMessage",errorRegistrationNotSupportedMessage);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+errorRegistrationNotSupportedMessage);
