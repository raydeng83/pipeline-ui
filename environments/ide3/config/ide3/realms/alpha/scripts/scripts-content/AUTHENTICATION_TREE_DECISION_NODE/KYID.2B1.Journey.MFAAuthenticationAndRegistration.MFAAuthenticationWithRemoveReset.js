...
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.2B1.Journey.MFAAuthenticationAndRegistration.MFAAuthenticationWithRemoveReset",
    timestamp: dateTime,
...
logger.debug("Printing the MFA Context Code ::::::: "  + MFAContextCode)
var newMFAOptions = []
if (MFAContextCode === 3) {
    ...
    try {
        ...
        for (var i = 0; i < userData.custom_MFAMethods.length; i++) {
            ...
            if(mfaMethod === "Default"){
                ...
                logger.debug("I am inside the email ...1");
                var userId = nodeState.get("_id");
                var userProfile = openidm.read("managed/alpha_user/" + userId)      
                nodestateEmail = userProfile.mail
                logger.debug("I am inside the email ...2"+nodestateEmail);
            ...
            if (selectedOutcome === 0) {
                ...
                for (var i = 0; i < mfaOptionsArray.length; i++) {
                    if (selectedIndex === i) {
                        ...
                        nodeLogger.debug(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "Printing the type of selectedMFA Option :: " + typeof(selectedMFAOption));
