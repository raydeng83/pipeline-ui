    ...
    try {
        ...
        if(selectedOutcome === 1){
            ...
            if(checkEmail == true){
                ...
                nodeLogger.debug(transactionid + "::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin +"::"+ "email validation failed ::"+value+nodeConfig.errorId_emailealidation);
                 errMsg["code"] = "ERR-INP-EML-000";
