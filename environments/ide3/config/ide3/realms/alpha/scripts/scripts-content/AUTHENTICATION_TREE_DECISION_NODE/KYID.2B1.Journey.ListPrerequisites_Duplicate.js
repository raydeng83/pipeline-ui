...
logger.debug("arrPreReqTypeIDs is in it "+ arrPreReqTypeIDs)
  try { 
      if(arrPreReqTypeIDs!= null){
       ...
       // if(nodeState.get("numberofRequest")!=null || nodeState.get("numberofRequest")!==undefined ){
       //      var workflow = {
       //              "name": {
       ...
       //              },
       //              "sequence":nodeState.get("numberofRequest")+1
       //          }
       // }else{
       //     var workflow = {
       //              "name": {
       ...
       //          }
       // }
        // logger.debug("numberofRequest is "+ nodeState.get("numberofRequest"));
...
function statusExistInRequest(txid,nodeLogger,ops,id,type,requesterID, sequence){
  ...
  //Local Variables  
   ...
   try { 
    ...
    logger.debug("status is in "+ status)
          ...
          //}
            ...
            action.goTo(nodeOutcome.DONE); 
                ...
                // } 
                    ...
                    //    //      // callbacksBuilder.confirmationCallback(0, ["Start","Cancel","View workflow status"], 0);                     
                    //    //  } else {
                    //         logger.debug("insdie else ")
                             
                    //         if(nodeState.get("isworkflow")==true){
                    //              logger.debug("Inside is approvers")
                    //             callbacksBuilder.textOutputCallback(0,JSON.stringify(response));
                    //             callbacksBuilder.confirmationCallback(0, ["Start","Cancel","View workflow status"], 0);
                    //             // action.goTo(nodeOutcome.NEXT);
                    //             // callbacksBuilder.textOutputCallback(0,JSON.stringify(response));
