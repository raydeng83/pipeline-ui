...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "First Time Login Error",
    script: "Script",
    scriptName: "KYID.Journey.FirstTimeLoginErrorMsg",
    timestamp: dateTime,
    errorMsg_EN: "esv.error.first.time.login.en",
    errorMsg_ES: "esv.error.first.time.login.es", 
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             firstTimeLoginError = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("firstTimeLoginError", firstTimeLoginError);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+firstTimeLoginError);
