...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "Expired Internal User Change Password Link Msg",
    script: "Script",
    scriptName: "KYID.Journey.ExpIntUsrPwdUpdateMsg",
    timestamp: dateTime,
    errorMsg_EN: "esv.updatepwdinternaladmsg.en",
    errorMsg_ES: "esv.updatepwdinternaladmsg.es", 
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             expiredIntUserPwdUpdate = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("expiredIntUserPwdUpdate",expiredIntUserPwdUpdate);
             nodeLogger.error(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+expiredIntUserPwdUpdate);
