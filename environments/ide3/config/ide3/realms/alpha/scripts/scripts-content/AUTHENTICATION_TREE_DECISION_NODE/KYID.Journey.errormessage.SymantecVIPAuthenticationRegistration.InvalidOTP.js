...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "Symantec Error Message",
    script: "Script",
    scriptName: "KYID.Journey.errormessage.SymantecVIPAuthenticationRegistration.InvalidOTP",
    timestamp: dateTime,
    errorMsg_EN: "esv.error.invalidotpsymantecvip.en",
    errorMsg_ES: "esv.error.invalidotpsymantecvip.es", 
