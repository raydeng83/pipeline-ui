...
// config = {
//     "name": "ReturnURL",
//     "value": decodeURIComponent(nodeState.get("returnURL")),
...
var mail = attributes.get("mail")
logger.error("attributes is :: "+ mail)
config = {
  "emailTemplateName" : "Reset Password",
  "emailAttribute" : "mail",
  "emailSuspendMessage" : {
    "en" : `An email has been sent to ${mail}. Click the link in that email to reset your password.`
  },
  "objectLookup" : true,
