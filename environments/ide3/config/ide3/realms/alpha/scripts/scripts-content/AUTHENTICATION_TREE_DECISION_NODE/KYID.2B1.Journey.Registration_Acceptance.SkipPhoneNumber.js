        ...
        if (selectedOutcome === 1) {
            ...
            if (selectedMFA === 1) {
                ...
                if (checkEmail == true) {
                    ...
                    nodeLogger.debug(transactionid+"::"+nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "email validation failed for "+value+"::"+nodeConfig.errorId_emailValidation);
                ...
                if (checdkPhone == false) {
                    nodeState.putShared("errorMessage", null);
                     nodeLogger.debug(transactionid+"::"+nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "phone validation failed ::"+nodeConfig.errorId_phoneValidation);
