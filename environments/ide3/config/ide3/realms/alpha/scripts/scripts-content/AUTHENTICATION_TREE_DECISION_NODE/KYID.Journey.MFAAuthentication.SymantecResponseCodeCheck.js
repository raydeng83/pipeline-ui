...
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.Journey.MFAAuthentication.SymantecResponseCodeCheck",
    timestamp: dateTime,
...
try {
    ...
    nodeLogger.error("AUDIT::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "Responsecode :: " + responsecode);
    nodeLogger.error("AUDIT::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "Responsebody :: " + responsebody);
    // 2024/10/30 add loggers to print out credID and security code
//    nodeLogger.error("AUDIT::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "CredID :: " + CredID);
//    nodeLogger.error("AUDIT::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "securityCode :: " + OTP);
    ...
    logger.error("Printing the reason code ::::::: " + extractTagValue(responsebody, "ReasonCode"))
    if (extractTagValue(responsebody, "ReasonCode") === "0000") {
         nodeLogger.error("************* INSIDE 0000 Response Code ****************")
