...
try {
    ...
    //logger.debug("existing session" +existingSession);
    var sessionDetails = {}
...
function auditLog(code, message){
     var auditLib = require("KYID.2B1.Library.AuditLogger")
                ...
                eventDetails["applicationLogo"] = nodeState.get("appLogo") || "";
                eventDetails["roleName"] = nodeState.get("roleName") || "";
                if(nodeState.get("prereqName")){
                    eventDetails["prerequisiteName"] = nodeState.get("prereqName") || "";
                }
                // eventDetails["roleId"] = nodeState.get("prereqRoleId") || "";
                var sessionDetails = {}
                var sessionDetail = null
