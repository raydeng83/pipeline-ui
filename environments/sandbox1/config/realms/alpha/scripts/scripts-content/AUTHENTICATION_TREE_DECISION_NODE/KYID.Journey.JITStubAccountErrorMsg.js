...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "JIT Stub Account Error",
    script: "Script",
    scriptName: "KYID.Journey.JITStubAccountErrorMsg",
    timestamp: dateTime,
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             jitStubAccountError = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("jitStubAccountError",jitStubAccountError);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+jitStubAccountError);
