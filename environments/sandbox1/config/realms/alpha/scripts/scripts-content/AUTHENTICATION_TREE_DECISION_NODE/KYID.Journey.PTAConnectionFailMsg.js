...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "Connection Failure Error Msg",
    script: "Script",
    scriptName: "KYID.Journey.PTAConnectionFailMsg",
    timestamp: dateTime,
    errorMsg_EN: "esv.adconnectionfailmsg.en",
    errorMsg_ES: "esv.adconnectionfailmsg.es", 
...
var libFunc = "";
var clocale = "";
var ptaConnectionFailErrorMessage = "";
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             ptaConnectionFailErrorMessage = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("ptaConnectionFailErrorMessage",ptaConnectionFailErrorMessage);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+ptaConnectionFailErrorMessage);
