...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "JIT InValid Account Error",
    script: "Script",
    scriptName: "KYID.Journey.JITInValidAccountErrorMsg",
    timestamp: dateTime,
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             jitInvalidAccountError = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("jitInvalidAccountError",jitInvalidAccountError);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+jitInvalidAccountError);
