...
function main() {
    ...
    if(!createTokenizedMailObject(tokenizedEmail)){
        ...
        //var link = "https://openam-commkentwf-useast1-dev.id.forgerock.io/am/XUI/?realm=alpha&authIndexType=service&authIndexValue=test-LanguageKYID-ForgotPassword&email="+decodeURIComponent(email);
