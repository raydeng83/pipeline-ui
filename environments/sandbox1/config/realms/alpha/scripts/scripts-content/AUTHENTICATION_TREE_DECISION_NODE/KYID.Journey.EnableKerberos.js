...
if (kerberosEnabled == null || kerberosEnabled == "") {
    nodeLogger.error(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script+"::"+nodeConfig.scriptName+":: missing kerberos enabled ESV, default to kerberos disabled ");
    action.goTo(nodeOutcome.KERBEROS_DISABLED);
} else {
    nodeLogger.error(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script+"::"+nodeConfig.scriptName+":: Kerberos authentication enabled: " + kerberosEnabled);
