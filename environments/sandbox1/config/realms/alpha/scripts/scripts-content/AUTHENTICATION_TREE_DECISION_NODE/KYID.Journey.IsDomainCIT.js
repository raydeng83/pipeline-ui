...
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.Journey.IsDomainCIT",
    timestamp: dateTime,
...
try{   
    if(nodeState.get("isinternaluser")!=null){
        if(!nodeState.get("isinternaluser")){
            nodeLogger.error(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script+"::"+nodeConfig.scriptName+"::"+nodeConfig.presentExtDomain);
