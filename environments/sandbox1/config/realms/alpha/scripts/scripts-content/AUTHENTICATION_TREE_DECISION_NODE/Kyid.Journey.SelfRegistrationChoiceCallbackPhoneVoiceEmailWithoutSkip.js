 ...
 */
//Kyid.Journey.SelfRegistrationChoiceCallbackPhoneVoiceEmailWithoutSkip
...
//if(mfaresponse===0){
    if(callbacks.isEmpty()){
        callbacksBuilder.textOutputCallback(1, "3_phone_number")
        callbacksBuilder.textInputCallback("Mobile Phone Number");    
