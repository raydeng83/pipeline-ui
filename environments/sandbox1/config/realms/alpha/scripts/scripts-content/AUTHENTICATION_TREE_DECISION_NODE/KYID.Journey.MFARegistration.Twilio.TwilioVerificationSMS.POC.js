...
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.Journey.MFARegistration.Twilio.TwilioVerificationSMS",
    timestamp: dateTime,
...
function getTelephoneNumber() {
   ...
   var telephoneNumber = nodeState.get("telephoneNumber");
    ...
    nodeLogger.error(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin + "Printing the telephone number" + telephoneNumber);
    var cleanedNumber;
...
var phoneNumber=getTelephoneNumber();
...
var requestOptions = {
  ...
  try {
    ...
    logger.error("Printing the response ::::: " + JSON.stringify(response));
   ...
   /* if(status === "pending"){
        ...
        action.goTo(NodeOutcome.INVALIDNUMBER);
            ...
            logger.error("*******Max Limit Exceed**********");
            action.goTo(NodeOutcome.MaxSendReached);
            }
        else {
            //action.goTo(NodeOutcome.FAILED);
         nodeLogger.error(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::"+"Unknown Error");
        }*/
