...
if (nodeState.get("forgeRock.device.profile") !== null) {
    ...
    //logger.error("deviceInfo: "+deviceInfo)
    ...
    nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script+"::"+nodeConfig.scriptName+"::"+nodeConfig.deviceInfoNotFound);
