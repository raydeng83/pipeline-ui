...
function getUserId() {
    try {
        var userId = "e5052712-1834-4093-873c-cab324386d8e";
    ...
    try {
        ...
        if (userId) {
            ...
            if (userData) {
                ...
                nodeLogger.error("userMFAMethods::newMFAOptions:::"+userMFAMethods+"::::::::"+newMFAOptions);
