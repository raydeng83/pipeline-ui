function scanViolation (policyId) {
 ...
 logger.error("Violation Scan Response from Journey is ::" + Response)
 logger.error("Violation Scan Response from Journey is ::" + Response.results.length)
   logger.error("Violation Scan Response from Journey is ::" + Response.results[0]) 
