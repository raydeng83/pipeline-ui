/**
 * Script: KYID.Journey.PasswordUpdateFailMsg
 * Description: This script is used to display password update fail error message.             
 * Date: 7th Sept 2024
 * Author: Deloitte
 **/
...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "Password Update Fail",
    script: "Script",
    scriptName: "KYID.Journey.PasswordUpdateFailMsg",
    timestamp: dateTime,
    errorMsg_EN: "esv.error.passwordupdatefailed.en",
    errorMsg_ES: "esv.error.passwordupdatefailed.es", 
...
var libFunc = "";
var clocale = "";
var errormessagepwdUpdateFailedinAD = "";
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             errormessagepwdUpdateFailedinAD = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("errormessagepwdUpdateFailedinAD",errormessagepwdUpdateFailedinAD);
             nodeLogger.error(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+errormessagepwdUpdateFailedinAD);
