...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "Redirects to KOG Create Account Form Page",
    script: "Script",
    scriptName: "KYID.Journey.RedirectToKOGCreateAccountForm",
    timestamp: dateTime,
...
try {
    if(systemEnv.getProperty("esv.kog.requestaccount.url") && systemEnv.getProperty("esv.kog.requestaccount.url")!=null){
         var kogurl = systemEnv.getProperty("esv.kog.requestaccount.url");
