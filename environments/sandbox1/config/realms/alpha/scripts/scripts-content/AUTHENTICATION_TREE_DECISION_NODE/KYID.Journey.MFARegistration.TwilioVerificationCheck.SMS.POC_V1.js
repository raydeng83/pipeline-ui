...
logger.error("**************Entering verify page***********")
// Node Config
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.Journey.MFARegistration.TwilioVerificationCheck.SMS",
    timestamp: dateTime,
...
function getDisplayMessage() {
    ...
    if (clocale === "en") {
        ...
        var displayMessage = "enter_verification_code_to" + boldoutput.bold() + ""
    }
    if (clocale === "es") {
    ...
    try {
        if (clocale === "en") {
            ...
            if (nodeState.get("resendcodeMessage") != null) {
                ...
                //callbacksBuilder.textOutputCallback(0,`<div class='error-message'>`+resendcodeMessage+`</div>`)
