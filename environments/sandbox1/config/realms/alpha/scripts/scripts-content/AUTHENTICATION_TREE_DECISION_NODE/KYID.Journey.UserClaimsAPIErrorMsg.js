...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "User Claims API Error",
    script: "Script",
    scriptName: "KYID.Journey.UserClaimsAPIErrorMsg",
    timestamp: dateTime,
    errorMsg_EN: "esv.error.userclaimapi.unexpected.en",
    errorMsg_ES: "esv.error.userclaimapi.unexpected.es", 
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             userClaimsAPIError = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("userClaimsAPIError",userClaimsAPIError);
             nodeLogger.error(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+userClaimsAPIError);
