...
if(nodeState.get("lang") && nodeState.get("lang")!=null){
    lang = nodeState.get("lang").toString();
...
var kogurl = systemEnv.getProperty("esv.expired.int.usr.pwd.update.url")+ "&clocale=" + lang + "&locale=" + lang;
config = {
    "failureUrl": kogurl
}