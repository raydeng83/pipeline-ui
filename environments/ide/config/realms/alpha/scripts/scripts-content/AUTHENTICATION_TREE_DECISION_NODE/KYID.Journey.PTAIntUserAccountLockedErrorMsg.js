...
// Node Config
 var nodeConfig = {
    ...
    timestamp: dateTime,
    errorMsg_EN: "esv.adaccountlockederrormsg.en",
    errorMsg_ES: "esv.adaccountlockederrormsg.es", 
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             logger.error("Inside_Error_Script");
             //nodeState.putShared("ptaAuthenticationFailErrorMessage","Int User:Your Account is locked Out");
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
