    ...
    try {
        ...
        if(isPhoneEditable == "false"){
            ...
            var test = isDuplicateNumberCheck(phone_Number);
                ...
                if (checkPhone== false){
                    nodeState.putShared("MaxLimitReachedSkipPhone","true");
                    nodeLogger.debug(transactionid + "::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.begin +"::"+"Invalid Phone Number" +"::"+phone_Number+"::"+nodeConfig.errorId_phoneNumber);
