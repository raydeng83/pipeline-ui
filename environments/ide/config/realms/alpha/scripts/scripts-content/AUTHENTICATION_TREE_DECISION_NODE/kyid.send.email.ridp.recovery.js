...
var nodeConfig = {
    ...
    templateID: "kyid2B1ProfileUpdated",
    begin: "Beginning Node Execution",
    node: "Node",
    // nodeName: "Read Enrollement Context Details",
    script: "Script",
    scriptName: "KYID.2B1.Send.Profile.Updated.Mail",
...
function sendMail(mail, givenName, sn, phoneContact, emailContact,templateId) {
...
function main() {
    try {
        ...
        if(nodeState.get("flowName") && nodeState.get("flowName").toLowerCase() == "forgotpassword"){
            outcome = sendMail(nodeState.get("mail"), nodeState.get("givenName"), nodeState.get("sn"), nodeState.get("phoneContact"), nodeState.get("emailContact"),"kyid2B1RidpForgotPassword"); 
