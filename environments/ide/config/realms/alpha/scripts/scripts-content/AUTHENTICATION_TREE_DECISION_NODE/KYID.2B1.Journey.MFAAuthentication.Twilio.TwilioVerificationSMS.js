...
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.Journey.MFAAuthentication.Twilio.TwilioVerificationSMS",
    timestamp: dateTime,
...
logger.debug("printing sid value "+ sidvalue)
logger.debug("printing authz code value "+ authCode)
