...
var nodeConfig = {
    ...
    script: "Script",
    scriptName: "KYID.Journey.MFADynamicChoiceCollectorForMFARecovery",
    timestamp: dateTime,
...
function availableMFAOptions(){
    ...
    var newMFAOptions = []
    //the MFA Context is set to 3 for MFA Recovery
    var MFAContextCode = 3
    if (MFAContextCode === 3) {
        ...
        if (callbacks.isEmpty()) {
            ...
            if (selectedOutcome === 0) {
                ...
                if (selectedMFAOption.includes(defaultMsgen) || selectedMFAOption.includes(defaultMsges)) {
                    ...
                    nodeState.putShared("recoveryauthmethod", "mail");
                    nodeState.putShared("blankmsg",null);
                    ...
                    nodeState.putShared("recoveryauthmethod", "phone");
