/**
 * Script: KYID.Journey.PasswordMismatchMsg
...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "Mismatch Pwd Error Msg",
    script: "Script",
    scriptName: "KYID.2B1.Password.Mismatch.Error",
    timestamp: dateTime,
    errorMsg_EN: "esv.mismatchpassworderrormsg.en",
    errorMsg_ES: "esv.mismatchpassworderrormsg.es", 
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             mismatchPasswordErrorMessage = libFunc.setErrorMessage("en", errLangMsgJSON); // Locale hardcoded to "en"
             nodeState.putShared("mismatchPasswordErrorMessage", mismatchPasswordErrorMessage);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+mismatchPasswordErrorMessage);
