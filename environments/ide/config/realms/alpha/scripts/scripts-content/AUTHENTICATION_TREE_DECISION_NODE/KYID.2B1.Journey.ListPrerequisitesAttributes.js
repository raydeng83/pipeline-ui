            ...
            if (response["pagenumber"] == (nextPage)) {
                ...
                if (response["onsubmit"] != null) {
                    ...
                    /*if(nodeState.get("requestmap")!=null && nodeState.get("responsemap")!=null){
                        logger.error("Request map in shared state - "+JSON.stringify(nodeState.get("requestmap")))
                        requestmappingJSON = getRequestObjMapDetails(nodeState.get("requestmap"));
                         logger.error("Response map in shared state - "+JSON.stringify(nodeState.get("responsemap")))
...
function main() {
    ...
    try {
        ...
        if (type != null && type) {
            ...
            logger.debug("pageNumber is in "+ pageNumber)
