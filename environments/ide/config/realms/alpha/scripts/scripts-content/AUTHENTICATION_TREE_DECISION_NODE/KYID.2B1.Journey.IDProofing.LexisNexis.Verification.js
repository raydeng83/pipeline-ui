    ...
    try {
        ...
        if(selectedOutcome === 0){
           ...
           // var parsedResponse = JSON.parse(response);
            ...
            logger.error("journeyName is KYID.2B1.Journey.IDProofing.LexisNexis.Verification :: " + nodeState.get("journeyName"))
        ...
        nodeLogger.error(transactionid + "::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + nodeConfig.end + "::" + "Error handleUserResponses Function " + error);
        action.goTo("error");
    }  
} 
...
//         //if (attrs[i].attributeName && (attrs[i].attributeName === "SSN" || attrs[i].attributeName.toLowercase() === "ssn")) 
