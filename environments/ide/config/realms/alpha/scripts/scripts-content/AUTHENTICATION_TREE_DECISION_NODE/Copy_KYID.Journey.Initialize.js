...
//     var SessionId=requestCookies.get("JSESSIONID") 
//     //var sessionData= getSessionData();
//     //var transactionId = sessionData.transactionId;
...
try {
    ...
    nodeLogger.error(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + "authnSessionCurrentTime" + "::" + authnSessionCurrentTime);
    nodeLogger.error(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + "authnSessionMaxTime" + "::" + authnSessionMaxTime);
    nodeLogger.error(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + "authnSessionRedirectTime" + "::" + authnSessionRedirectTime);
    nodeLogger.error(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + "authnSessionRedirectUrl" + "::" + authnSessionRedirectUrl);
    nodeLogger.error(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + "authnSessionCheckInterval" + "::" + authnSessionCheckInterval);
