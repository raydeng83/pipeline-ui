...
/*if (readCookieValueFromSession("SetIdentityAssertionCompleted") != null && readCookieValueFromSession("SetIdentityAssertionCompleted").toLowerCase() == "true") {
    nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script+"::"+nodeConfig.scriptName+":: IdentityAssertionCompleted. Skipping Identity Assertion Node.");
    ...
    nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script+"::"+nodeConfig.scriptName+":: Found SetSkipKerberos cookie as true. Skipping Kerberos.");
    action.goTo('True');
} else {
    nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script+"::"+nodeConfig.scriptName+":: SetSkipKerberos cookie is false or no SetSkipKerberos cookie is present. Going to Kerberos. ");
    action.goTo('False');
}
