...
function getUserId() {
    try {
        ...
        nodeLogger.debug(nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + "Error retrieving user ID from node state: " + error.message);
        return null;
    }
}
    ...
    try {
        ...
        /*if (callbacks.isEmpty()) {
         ...
         if (callbacks.isEmpty()) {
            ...
            // }
               // else 
                if (selectedMFAOption.includes("Phone") || selectedMFAOption.includes("teléfono")) {
    ...
    try {
        ...
        if (userId) {
            ...
            if (userData) {
                ...
                logger.debug("printing userMFAMethods" + userMFAMethods);
