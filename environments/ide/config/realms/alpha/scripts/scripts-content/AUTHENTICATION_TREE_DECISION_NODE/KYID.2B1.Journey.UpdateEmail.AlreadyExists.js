...
var mail = nodeState.get("mail");
  ...
  var nodeConfig = {
      ...
      node: "Node",
      nodeName: "Email Already Exists",
      script: "Script",
      scriptName: "KYID.2B1.Journey.UpdateEmail.AlreadyExists",
      timestamp: dateTime,
...
function requestCallbacks() {
    ...
    try {
        errMsg["code"] = "ERR-CHN-EML-004";
        errMsg["message"] = libError.readErrorMessage("ERR-CHN-EML-004"); 
