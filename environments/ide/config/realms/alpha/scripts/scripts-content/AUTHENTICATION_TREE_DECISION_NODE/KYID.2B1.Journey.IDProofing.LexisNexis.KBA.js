...
function main() {
    ...
    try {
        ...
        if(flowName && (flowName.toLowerCase() === "createaccount" || (flowName.toLowerCase() === "firsttimelogin" && !nodeState.get("isMFARecovery")))){
            action.goTo("noKBA");
        }else if((ridpMethod && ridpMethod.toLowerCase() == "lexisnexisverification")  && (flowName && (flowName.toLowerCase() === "updateprofile" || flowName.toLowerCase() === "organdonor"))){
            action.goTo("noKBA");
        }else{
