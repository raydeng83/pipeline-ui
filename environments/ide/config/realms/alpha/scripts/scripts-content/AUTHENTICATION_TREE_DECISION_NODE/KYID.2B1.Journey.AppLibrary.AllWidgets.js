...
function requestCallbacks() {
    ...
    //Show the role removal message on the applibrary screen
    ...
    try {
        ...
        logger.debug("Error in requestCallbacks: " + error.message);
    }
}
        ...
        if (selectedOutcome === 0) {
            try {
               ...
               var roleOrAppId = null;
                ...
                logger.debug("JSON parsing error: " + jsonErr.message);
