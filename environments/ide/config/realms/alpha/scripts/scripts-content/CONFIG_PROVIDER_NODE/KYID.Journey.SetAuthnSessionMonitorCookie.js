 ...
 */
 ...
 var isAuthSessionMonitorCookieSet = "no";
 if(nodeState.get("isauthsessionmonitorcookieset") && nodeState.get("isauthsessionmonitorcookieset")!=null){
     isAuthSessionMonitorCookieSet = nodeState.get("isauthsessionmonitorcookieset").toString();
 } 
 logger.error("Value of isAuthSessionMonitorCookieSet: "+isAuthSessionMonitorCookieSet);

config = {
    "name": "isAuthSessionMonitorCookieSet",
    "value": isAuthSessionMonitorCookieSet,
    "domain": systemEnv.getProperty("esv.kyid.cookie.domain"),
    "path": "/",
