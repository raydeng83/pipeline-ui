...
//the below function is used for APIs that run without access token and are protected by certificate provided by SIH
function processHttpRequestwithCert(apiName,apiURL,methodType,jsonObjBody,bearerToken,kyidclientName) {
    
    var resultJSON = {};
    try{
         if(JSON.stringify(jsonObjBody).length > 2 && jsonObjBody!=null){
             var apiRequest = {
                            clientName: kyidclientName,
                            method: methodType,
                            headers: {
                                "Content-Type": "application/json"
                              },
...
exports.processHttpRequestwithCert = processHttpRequestwithCert;