          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <p>Una solicitud de inscripción para {{object.requestedUserEmail}} al KYID {{object.applicationName}} se canceló el {{object.updatedTime}}.
</p>
                {{#if object.reason}}
                <p>Motivo de la cancelación: {{object.reason}}
</p>{{/if}}
                
                <p>
                 Este mensaje es sólo para su información y no se requiere ninguna acción adicional por su parte.
                </p>
                <p>Si tiene alguna pregunta, Comuníquese inmediatamente con nuestro equipo de soporte de KYID llamando al {{object.phoneContact}} y seleccione la opción 2 para comunicarse directamente con ellos.
</p>
                <p>
