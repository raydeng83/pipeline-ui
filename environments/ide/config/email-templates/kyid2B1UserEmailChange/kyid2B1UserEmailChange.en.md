          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <p>The primary email address associated with your KYID account was recently changed :
                
              </p>
                <p>Previous Email Address: {{object.oldMail}}</p>
                <p>New Email Address:  {{object.newMail}}</p>
                <p>
