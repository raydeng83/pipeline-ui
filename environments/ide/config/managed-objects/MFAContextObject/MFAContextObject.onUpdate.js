...
logger.error(" MFAContextObject on update script enableAuditLog - " + enableAuditLog)
logger.error(" MFAContextObject on update script defaultUserId - " + defaultUserId)
try {
    logger.error(" MFAContextObject on update script context value - " + context)
    logger.error(" MFAContextObject on update script old object value - " + oldObject)
    logger.error(" MFAContextObject on update script request value - " + request)
} catch (error) {
    logger.error("MFAContextObject on update script exception while printing context and request value")
}

if (enableAuditLog === "true") {

    function updateAttributes() {
        logger.error("MFAContextObject on update script method started")
        ...
        try {
            ...
            try {
                ...
                createdBy = ""
                logger.error("MFAContextObject on update script exception createdBy")
            }
            ...
            try {
                ...
                updatedBy = ""
                logger.error("MFAContextObject on update script exception updatedBy")
            }


            logger.error("MFAContextObject on update script createdBy started" + createdBy)
            logger.error("MFAContextObject on update script updatedBy started" + updatedBy)
            ...
            var fullname = "";
                ...
                try {
                    ...
                    logger.error("MFAContextObject on update script isoDateTimeFormat: " + isoDateTimeFormat)
                } catch (error) {
                    isoDateTimeFormat = ""
                    logger.error("MFAContextObject on update script exception isoDateTimeFormat")
                }

                try {
                    epochTimeFormat = Date.parse(isoDateTimeFormat);
                    logger.error("MFAContextObject on update script epochTimeFormat: " + epochTimeFormat)
                } catch (error) {
                    epochTimeFormat = ""
                    logger.error("MFAContextObject on update script exception epochTimeFormat")
                }
                ...
                try {
                    if (context != null && context) {
                        if (context.oauth2.rawInfo.user_id != null) {
                            ...
                            logger.error("MFAContextObject on update script usernameUpdatedBy: " + usernameUpdatedBy)
                        }else{
                    ...
                    usernameUpdatedBy = ""
                    logger.error("MFAContextObject on update script exception usernameUpdatedBy")
                }
                ...
                logger.error("MFAContextObject on update script fullname: " + fullname)
                logger.error("MFAContextObject on update script usernameUpdatedBy: " + usernameUpdatedBy)
            ...
            logger.error("MFAContextObject on update script exception while updating attributes")
        }
    }
