    ...
    function updateAttributes() {
        ...
        try {
            ...
            try {
                ...
                createdBy = ""
                logger.error("alpha_kyid_systemmessages on update script exception createdBy")
            }
            ...
            try {
                ...
                updatedBy = ""
                logger.error("alpha_kyid_systemmessages on update script exception updatedBy")
            }
            ...
            var fullname = "";
                ...
                try {
                    ...
                    logger.error("alpha_kyid_systemmessages on update script isoDateTimeFormat: " + isoDateTimeFormat)
                } catch (error) {
                    isoDateTimeFormat = ""
                    logger.error("alpha_kyid_systemmessages on update script exception isoDateTimeFormat")
                }
                ...
                try {
                    ...
                    epochTimeFormat = ""
                    logger.error("alpha_kyid_systemmessages on update script exception epochTimeFormat")
                }
                ...
                try {
                    ...
                    usernameUpdatedBy = ""
                    logger.error("alpha_kyid_systemmessages on update script exception usernameUpdatedBy")
                }
            ...
            logger.error("alpha_kyid_systemmessages on update script exception while updating attributes")
        }
    }
