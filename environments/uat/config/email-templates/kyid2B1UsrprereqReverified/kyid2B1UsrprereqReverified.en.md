...
<html>
  <head>
    <meta />
    <title>User Pre-Requiste Reverified</title>
  </head>
          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;margin-top:20px;border:1px solid #ddd">
            ...
            <tr>
              <td style="padding:30px 40px">
                ...
                <p>Pre-requisite associated with your account has been successfully reverified. Please see below for the details:
</p>
                ...
                <br />
                <p>The successful reverification confirms that you continue to meet the necessary requirements for accessing KYID 
                  
                  
                  
                  <strong> {{object.applicationName}}  </strong> with the 
                  
                  
                  
                  <strong> {{object.roleName}} .</strong>
                </p>
                <p>
