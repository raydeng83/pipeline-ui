...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "Stub Account Error Msg",
    script: "Script",
    scriptName: "KYID.Journey.StubAccountMsg",
    timestamp: dateTime,
    errorMsg_EN: "esv.stubusrmsg.en",
    errorMsg_ES: "esv.stubusrmsg.es", 
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             stubAccountErrorMessage = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("stubAccountErrorMessage",stubAccountErrorMessage);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+stubAccountErrorMessage);
