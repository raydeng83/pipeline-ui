...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "Unknown Error Msg",
    script: "Script",
    scriptName: "KYID.Journey.KOGProfileAPIFailMsg",
    timestamp: dateTime,
    errorMsg_EN: "esv.failedusrmsg.en",
    errorMsg_ES: "esv.failedusrmsg.es", 
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             profileApifailErrorMsg = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("profileApifailErrorMsg",profileApifailErrorMsg);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+profileApifailErrorMsg);
