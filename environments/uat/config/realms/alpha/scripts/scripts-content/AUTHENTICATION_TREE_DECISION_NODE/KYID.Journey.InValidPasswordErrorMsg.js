/**
 * Script: KYID.Journey.InValidPasswordErrorMsg
...
// Node Config
 var nodeConfig = {
    ...
    node: "Node",
    nodeName: "inValid Password Error Msg",
    script: "Script",
    scriptName: "KYID.Journey.InValidPasswordErrorMsg",
    timestamp: dateTime,
    errorMsg_EN: "esv.invalidpassworderrormsg.en",
    errorMsg_ES: "esv.invalidpassworderrormsg.es", 
...
var libFunc = "";
var clocale = "";
var inValidPasswordErrorMessage = "";
    ...
    if(!isMandatoryConfigParamsPresent()){
        action.goTo(nodeOutcome.ERROR);
         ...
         try{
             ...
             inValidPasswordErrorMessage = libFunc.setErrorMessage(getLocale(),errLangMsgJSON);
             nodeState.putShared("inValidPasswordErrorMessage",inValidPasswordErrorMessage);
             nodeLogger.debug(nodeConfig.timestamp+"::"+nodeConfig.node+"::"+nodeConfig.nodeName+"::"+nodeConfig.script
                     +"::"+nodeConfig.scriptName+"::"+nodeConfig.errorMsg+"::"+inValidPasswordErrorMessage);
