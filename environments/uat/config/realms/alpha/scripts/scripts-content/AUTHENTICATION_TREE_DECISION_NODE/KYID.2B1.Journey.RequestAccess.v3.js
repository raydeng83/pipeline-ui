...
try {
    ...
    logger.error("appIDinWidget from request param or nodeState is: " + appName);
    ...
    logger.error("The appId is: " + appId);
...
function requestCallbacks(appName, userId, appId) {
    try {
        ...
        logger.error("Requestable unmatched roles: " + JSON.stringify(unmatchedRequestableRoles));
