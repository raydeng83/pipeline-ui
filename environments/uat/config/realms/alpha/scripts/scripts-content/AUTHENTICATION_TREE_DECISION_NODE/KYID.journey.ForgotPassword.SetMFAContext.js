...
function logSharedState() {
    //logger.error("Printing the shared state for MFA Context:::::: " + nodeState.get("isMFARequired"));
    //logger.error(" :::: " + nodeState.get("requiredMFAMethodCode"));
   // logger.error("::::"  + nodeState.get("IsRegistrationAllowed"));
}
...
// // Log the result
// logger.error("Outcome determined: " + outcome);
