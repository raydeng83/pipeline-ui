        ...
        if(nodeState.get("counter")!==null){
            ...
            if(nodeState.get("totalJITRecords") && nodeState.get("totalJITRecords")!=null){
                ...
                if(counter == totalJITRecords){
                    ...
                    nodeState.putShared("JITStatus","completed")
                    ...
                    nodeLogger.error(transactionid + "::" + nodeConfig.timestamp + "::" + nodeConfig.node + "::" + nodeConfig.nodeName + "::" + nodeConfig.script + "::" + nodeConfig.scriptName + "::" + " Counter exceeded total JIT Records, going to error state");
                    action.goTo("error");
                }
            }
        }
