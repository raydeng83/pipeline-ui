...
var lang = nodeState.get("lang").toString();
logger.error("Printing the return value of getLocale function ::::::::: " + lang);
...
try {
    ...
    var kogurl = url + "/am/XUI/?realm=alpha&authIndexType=service&authIndexValue=kyid_ForgotPasswordCITDomainError" + "&clocale=" + lang + "&locale=" + lang;
    //var kogurl = url + "/am/XUI/?realm=alpha&authIndexType=service&authIndexValue=kyid_loginPTA" + "&clocale=" + lang + "&locale=" + lang + "&CITDomainPart=isPartOfCITDomain";
    //var kogurl = "https://openam-commkentwf-useast1-uat2.id.forgerock.io/am/XUI/?realm=alpha&authIndexType=service&authIndexValue=kyid_loginPTA" + "&clocale=" + lang + "&locale=" + lang + "&CITDomainPart=isPartOfCITDomain";
    config = {
        "failureUrl": kogurl
    }
}
