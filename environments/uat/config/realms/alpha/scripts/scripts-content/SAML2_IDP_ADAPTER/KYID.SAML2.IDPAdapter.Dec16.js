...
function preAuthentication() {
   ...
   logger.error(adapterLoggerPrefix+"::"+"ENTERING PREAuthentication FUNCTION"+"::"+reqId);
    ...
    if(issuer.localeCompare(systemEnv.getProperty("esv.logout.app.url")) == 0 && !session) {
        ...
        logger.error(adapterLoggerPrefix+"::"+"displayUrl PRESENT IN PREAuthentication"+"::"+displayUrl);
        var cookieName_displayUrl = "ReturnURL_" + reqId;
        response.addHeader("Set-Cookie", cookieName_displayUrl + "=" + decodeURIComponent(displayUrl) + "; Path=/; HttpOnly");
        ...
        var cookieName_wtrealmUrl = "rp-realm_" + reqId;
      	response.addHeader("Set-Cookie", cookieName_wtrealmUrl+ "=" + decodeURIComponent(wtrealmUrl) + "; Path=/; HttpOnly");
        isWsfedApp=true;
        ...
        var cookieName_wtrealmUrl = "rp-realm_" + reqId;
        response.addHeader("Set-Cookie", cookieName_displayUrl + "=" + decodeURIComponent(displayUrl) + "; Path=/; HttpOnly");
        response.addHeader("Set-Cookie", cookieName_wtrealmUrl + "=" + decodeURIComponent(displayUrl) + "; Path=/; HttpOnly");
        ...
        response.addHeader("Set-Cookie", cookieName_wtrealmUrl+ "=" + "; Path=/; expires=Thu, 01 Jan 1970 00:00:00 UTC; HttpOnly")
