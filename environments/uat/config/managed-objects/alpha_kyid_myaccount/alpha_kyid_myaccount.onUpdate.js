...
logger.error(" alpha_kyid_myaccount on update script enableAuditLog - " + enableAuditLog)
logger.error(" alpha_kyid_myaccount on update script defaultUserId - " + defaultUserId)
try {
    logger.error(" alpha_kyid_myaccount on update script context value - " + context)
    logger.error(" alpha_kyid_myaccount on update script old object value - " + oldObject)
    logger.error(" alpha_kyid_myaccount on update script request value - " + request)
} catch (error) {
    logger.error("alpha_kyid_myaccount on update script exception while printing context and request value")
}

if (enableAuditLog === "true") {

    function updateAttributes() {
        logger.error("alpha_kyid_myaccount on update script method started")
        ...
        try {
            ...
            try {
                ...
                createdBy = ""
                logger.error("alpha_kyid_myaccount on update script exception createdBy")
            }
            ...
            try {
                ...
                updatedBy = ""
                logger.error("alpha_kyid_myaccount on update script exception updatedBy")
            }


            logger.error("alpha_kyid_myaccount on update script createdBy started" + createdBy)
            logger.error("alpha_kyid_myaccount on update script updatedBy started" + updatedBy)
            ...
            var fullname = "";
                ...
                try {
                    ...
                    logger.error("alpha_kyid_myaccount on update script isoDateTimeFormat: " + isoDateTimeFormat)
                } catch (error) {
                    isoDateTimeFormat = ""
                    logger.error("alpha_kyid_myaccount on update script exception isoDateTimeFormat")
                }

                try {
                    epochTimeFormat = Date.parse(isoDateTimeFormat);
                    logger.error("alpha_kyid_myaccount on update script epochTimeFormat: " + epochTimeFormat)
                } catch (error) {
                    epochTimeFormat = ""
                    logger.error("alpha_kyid_myaccount on update script exception epochTimeFormat")
                }
                ...
                try {
                    if (context != null && context) {
                        if (context.oauth2.rawInfo.user_id != null) {
                            ...
                            logger.error("alpha_kyid_myaccount on update script usernameUpdatedBy: " + usernameUpdatedBy)
                        }else{
                    ...
                    usernameUpdatedBy = ""
                    logger.error("alpha_kyid_myaccount on update script exception usernameUpdatedBy")
                }
                ...
                logger.error("alpha_kyid_myaccount on update script fullname: " + fullname)
                logger.error("alpha_kyid_myaccount on update script usernameUpdatedBy: " + usernameUpdatedBy)
            ...
            logger.error("alpha_kyid_myaccount on update script exception while updating attributes")
        }
    }
