    ...
    function updateAttributes() {
        try {
            ...
            try {
                ...
                createdBy = ""
                logger.error("alpha_assignment on update script exception createdBy")
            }
            ...
            try {
                ...
                updatedBy = ""
                logger.error("alpha_assignment on update script exception updatedBy")
            }
            ...
            var fullname = "";
                ...
                try {
                    ...
                    isoDateTimeFormat = ""
                    logger.error("alpha_assignment on update script exception isoDateTimeFormat")
                }

                try {
                    epochTimeFormat = Date.parse(isoDateTimeFormat);
                    logger.error("alpha_assignment on update script epochTimeFormat: " + epochTimeFormat)
                } catch (error) {
                    epochTimeFormat = ""
                    logger.error("alpha_assignment on update script exception epochTimeFormat")
                }
                ...
                try {
                    ...
                    usernameUpdatedBy = ""
                    logger.error("alpha_assignment on update script exception usernameUpdatedBy")
                }
            ...
            logger.error("alpha_assignment on update script exception while updating attributes")
        }
    }
